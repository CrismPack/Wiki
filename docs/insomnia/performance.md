...
These tips exists to help you achieve the optimum performance when using the **Insomnia: Hardcore** modpack.

1. Install and use GraalVM 17 or above. [GraalVM](https://www.graalvm.org/downloads/)
